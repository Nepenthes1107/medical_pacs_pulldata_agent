...
from app.agent.tool_schemas import KnowledgeItem, SearchKnowledgeInput, SearchKnowledgeOutput
...
def _dense_retrieve(query: str, category: Optional[str], k: int) -> List[Dict]:
...
def _bm25_retrieve(query: str, category: Optional[str], k: int) -> List[Dict]:
