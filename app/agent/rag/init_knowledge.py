...
from app.agent.rag import lexical, store
from app.agent.rag.documents import build_chunks, document_manifest
from app.agent.rag.download_sources import MANIFEST_PATH, download_sources

logger = logging.getLogger(__name__)


def init_knowledge(incremental: bool = False, manifest_path: Optional[str] = None) -> Dict:
...
def update_knowledge(manifest_path: Optional[str] = None) -> Dict:
