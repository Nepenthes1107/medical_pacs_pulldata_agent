...
def mark_aborted(
    ...
    series_instance_uids: Optional[List[str]] = None,
) -> bool:
...
def is_image_aborted(study_instance_uid: Optional[str], series_instance_uid: Optional[str]) -> bool:
...
def count_rejected(study_instance_uid: Optional[str]) -> int:
...
def rejected_count(study_instance_uid: Optional[str]) -> int:
